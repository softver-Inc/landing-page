...
const Form = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-[30em] bg-gray-50 p-5 rounded">
      <div className="mb-4">
        ...
        <input
          ...
          className="border-2 rounded-md py-2 px-4 w-full focus:outline-none focus:ring-blue-500"
        />
      </div>
      <div className="mb-4">
        <label htmlFor="name" className="text-sm font-semibold">
      ...
      <div className="mb-4 ">
        ...
        <textarea
          ...
          className="border-2 rounded-md py-2 px-4 w-full h-40 focus:outline-none focus:ring-blue-500"
        ></textarea>
      </div>
